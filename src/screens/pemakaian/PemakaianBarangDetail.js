...
//         if (isActive) setListPemakaian(result ?? []);
//     }
...
//         <Text style={styles.label}>Pemakaian Tanggal:</Text>
//     <Text style={styles.tanggalValue}>{listPemakaian.tanggal}</Text>
//       </View>

//       <FlatList
//         data={listPemakaian.items}
//         keyExtractor={(item, index) => index.toString()}
//         renderItem={renderItem}
//         ListEmptyComponent={
//           <Text style={styles.empty}>Tidak ada pemakaian pada tanggal ini.</Text>
//         }
//       />
//     </View>
//   );
...
//   jumlahContainer: { backgroundColor: '#ffebee', padding: 8, borderRadius: 5 },
//   jumlahText: { color: '#d32f2f', fontWeight: 'bold' },
